...
public class Recomendaciones extends javax.swing.JFrame {
     ...
     */
    private static ArrayList<Movie> listadoDePeliculas;
    
    public Recomendaciones(ArrayList<Movie> listadoDePeliculas) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Recomendaciones(listadoDePeliculas).setVisible(true);
            }
        });
    }
